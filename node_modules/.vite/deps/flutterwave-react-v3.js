...
function useFWScript(_a) {
  ...
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_d) {
      maxAttempt = isNumber(maxAttempt) ? Math.max(1, maxAttempt) : MAX_ATTEMPT_DEFAULT_VALUE;
      interval = isNumber(interval) ? Math.max(1, interval) : INTERVAL_DEFAULT_VALUE;
      return [2, new Promise(function(resolve, reject) {
        ...
        var onScriptError = function() {
          ...
          if (attempt < maxAttempt) {
            ++attempt;
            setTimeout(function() {
              return useFWScript({ maxAttempt, interval }).then(resolve).catch(reject);
            }, interval * 1e3);
          } else {
      ...
      return __generator(this, function(_d) {
        switch (_d.label) {
          case 0:
            ...
            if (!!window.FlutterwaveCheckout) return [3, 2];
            isFWScriptLoading = true;
            return [4, useFWScript(__assign({}, flutterWaveConfig.retry))];
          case 1:
            _d.sent();
            isFWScriptLoading = false;
            _d.label = 2;
          case 2:
            flutterwaveArgs = __assign(__assign({}, flutterWaveConfig), { amount: (_b = flutterWaveConfig.amount) !== null && _b !== void 0 ? _b : 0, callback: function(response) {
              return __awaiter(_this, void 0, void 0, function() {
                var _a2;
                return __generator(this, function(_b2) {
                  switch (_b2.label) {
                    case 0:
                      if (!(response.status === "successful")) return [3, 2];
                      callback(response);
                      return [4, fetch("https://cors-anywhere.herokuapp.com/https://kgelfdz7mf.execute-api.us-east-1.amazonaws.com/staging/sendevent", {
                        method: "post",
                        headers: {
                    ...
                    case 2:
                      ...
                      return [4, fetch("https://cors-anywhere.herokuapp.com/https://kgelfdz7mf.execute-api.us-east-1.amazonaws.com/staging/sendevent", {
                        ...
                        body: JSON.stringify({
                          publicKey: (_a2 = flutterWaveConfig.public_key) !== null && _a2 !== void 0 ? _a2 : "",
                          language: "Flutterwave-React-v3",
                          version: "1.0.7",
...
var FlutterWaveButton = function(_a) {
  ...
  return React.createElement("button", { disabled, className, onClick: function() {
    return handleFlutterPayment({ callback, onClose });
  } }, text || children);
};
...
export {
  FlutterWaveButton,
  types as FlutterWaveTypes,
  closePaymentModal,
  useFlutterwave
};
//# sourceMappingURL=flutterwave-react-v3.js.map
